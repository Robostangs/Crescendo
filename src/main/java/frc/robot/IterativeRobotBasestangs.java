 ...
 * </ul>
 */
public abstract class IterativeRobotBasestangs extends RobotBase {
  private enum Mode {
    kNone,
    kDisabled,
    kAutonomous,
  ...
  private final Watchdogstangs m_watchdog;
   ...
   */
  protected IterativeRobotBasestangs(double period) {
    m_period = period;
    m_watchdog = new Watchdogstangs(period, this::printLoopOverrunMessage);
  }
  ...
  protected void loopFunc() {
    ...
    m_watchdog.putToSmartDashboard();
